...
defined('DATABASE_NAME') ? NULL : define('DATABASE_NAME', 'mantenimiento');
defined('DATABASE_USER') ? NULL : define('DATABASE_USER', 'fidel');
defined('DATABASE_PASSWORD') ? NULL : define('DATABASE_PASSWORD', 'Lagunas242.');
